# H3Landscape - sprites of towns on the adventure map
...
| Tower      | grass   | `AVCTowVG.def` | `AVCTowFG.def` | `AVCTowCG.def` | `AVCTowXG.def` | `AVCTowZG.def` |

Sprites edited by Zachariasz, based on the original town sprites from RoE and HotA.