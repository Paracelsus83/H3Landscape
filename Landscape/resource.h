...
#ifndef H3L_DLL_FLAGS
#	if   defined(_DEBUG)
#		define H3L_DLL_FLAGS VS_FF_DEBUG
#	elif defined(H3L_RELEASE)
#		define H3L_DLL_FLAGS 0x0L
#	elif defined(H3L_PROD_VERSION)
#		define H3L_DLL_FLAGS VS_FF_PRERELEASE
#	else
#		define H3L_DLL_FLAGS VS_FF_PRIVATEBUILD
#	endif
#endif
...
#	define H3L_DLL_VERSION H3L_PROD_VERSION
#endif
